...
export type CreateBlockMutation = (
  ...
  & { createBlock: (
    { __typename?: 'Block' }
    & Pick<Block, 'id' | 'content' | 'type' | 'boldness' | 'order' | 'pageLink' | 'checked' | 'indentationLevel'>
    & { page: (
      { __typename?: 'Page' }
      & Pick<Page, 'id'>
    ) }
...
export function useGetAllPagesQuery(baseOptions?: Apollo.QueryHookOptions<GetAllPagesQuery, GetAllPagesQueryVariables>) {
        return Apollo.useQuery<GetAllPagesQuery, GetAllPagesQueryVariables>(GetAllPagesDocument, baseOptions);
      }
export function useGetAllPagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllPagesQuery, GetAllPagesQueryVariables>) {
          return Apollo.useLazyQuery<GetAllPagesQuery, GetAllPagesQueryVariables>(GetAllPagesDocument, baseOptions);
        }
...
export function useGetBlockQuery(baseOptions: Apollo.QueryHookOptions<GetBlockQuery, GetBlockQueryVariables>) {
        return Apollo.useQuery<GetBlockQuery, GetBlockQueryVariables>(GetBlockDocument, baseOptions);
      }
export function useGetBlockLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetBlockQuery, GetBlockQueryVariables>) {
          return Apollo.useLazyQuery<GetBlockQuery, GetBlockQueryVariables>(GetBlockDocument, baseOptions);
        }
