...
var Editor = {
  ...
  nodes: function* nodes(editor) {
    ...
    try {
      for (var _iterator5 = nodeEntries[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
var Node = {
  ...
  fragment: function fragment(root, range) {
    ...
    var newRoot = immer.produce(root, function (r) {
      ...
      try {
        for (var _iterator4 = nodeEntries[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var _step4$value = slicedToArray(_step4.value, 2),
              path = _step4$value[1];
